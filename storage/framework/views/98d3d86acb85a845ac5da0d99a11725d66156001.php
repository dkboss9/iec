...
<?php $__env->startSection('title','Featured Posts'); ?>
                                                    ...
                                                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12  file-box">
                                                        <div class="file">
                                                            ...
                                                            <div class="file-name">
                                                                ...
                                                                <br>
                                                                <span>Added-at: </span>
                                                                <span><?php echo e(Timezone::convertToLocal($row->created_at, 'Y:m:d g:i')); ?></span>
                                                            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\fstv\resources\views/admin/featured.blade.php ENDPATH**/ ?>