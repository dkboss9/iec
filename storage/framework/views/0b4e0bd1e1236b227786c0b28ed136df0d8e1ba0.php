<?php echo $__env->make('admin.section.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <div class="wrapper theme-1-active pimary-color-red">
		<!-- Top Menu Items -->
		<?php echo $__env->make('operator.section.top-navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
		<!-- /Top Menu Items -->
		
		<!-- Left Sidebar Menu -->
		<?php echo $__env->make('operator.section.left-sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
		<!-- /Left Sidebar Menu -->
	...
	<?php /**PATH /home/ausnepc/firescreen.ausnep.com/resources/views/layouts/operator.blade.php ENDPATH**/ ?>