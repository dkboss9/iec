    ...
    <div class="main--breadcrumb">
        <div class="container">
            <ul class="breadcrumb">
                ...
                <li class="active"><span>Featured Videos</span></li>
            </ul>
        </div>
    </div>
    <!-- Main Breadcrumb End -->
                ...
                <div class="main--content col-md-8 col-sm-7" data-sticky-content="true">
                    <div class="sticky-content-inner">
                        ...
                        <div class="post--items post--items-5 pd--30-0">
                            <ul class="nav">
                        <?php $count=1;?>
                        <?php $__currentLoopData = $fvideos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($count%3 == 1): ?>
                            <?php endif; ?>
                                <li>
                                    <!-- Post Item Start -->
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 col-sm-12 col-xs-4 col-xxs-12">
                                                <div class="post--img">
                                                    <div class="product" >
                                                        ...
                                                        <?php } ?>
                                                        <div class="title">
                                                            <h3 class="h5"><a class="btn-link"><?php echo Illuminate\Support\Str::limit($item->video_info['title'], 50); ?></a></h3>
                                            ...
                                            <div class="col-md-8 col-sm-12 col-xs-8 col-xxs-12">
                                                <div class="post--info">
                                                    ...
                                                    <div class="title">
                                                        <h3 class="h4"><a href="<?php echo e(route('video-detail', $item->video_info['id'])); ?>" class="btn-link"><?php echo Illuminate\Support\Str::limit($item->video_info['title'], 50); ?></a></h3>
                                                        <?php $__currentLoopData = $item->video_info['tags']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <div class="post--action">
                                                    <a href="<?php echo e(route('video-detail', $item->video_info['id'])); ?>"><?php echo e($item->video_info['subtitle']); ?> ...</a>
                                                </div>
                                            </div>
                                        </div>
                                        <a href="<?php echo e(route('subcat_video', $item->video_info->submenu_info['id'])); ?>"><?php echo e($item->video_info->submenu_info['title']); ?></a>
                                        <span><?php if(isset($item->video_info->childmenu_info)): ?> >> <a href="<?php echo e(route('childcat_video',$item->video_info->childmenu_info['id'])); ?>"><?php echo e($item->video_info->childmenu_info['title']); ?></a> <?php endif; ?></span>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ausnepc/firescreen.ausnep.com/resources/views/frontend/fstv/featured-video.blade.php ENDPATH**/ ?>