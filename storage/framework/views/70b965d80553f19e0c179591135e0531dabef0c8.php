            ...
            <div class="panel panel-default card-view">
                <div class="panel-heading">
                    ...
                    <div class="pull-right">
                        <a href="<?php echo e(route('question.create')); ?>" class="btn btn-default btn-rounded" style="border-bottom: 50%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <ul class="nav nav-pills">
                                                            <li>
                                                                <a data-toggle="tooltip" data-placement="bottom" title="edit" href="<?php echo e(route('question.edit', $value->id)); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ausnepc/firescreen.ausnep.com/resources/views/admin/quiz/question-list.blade.php ENDPATH**/ ?>