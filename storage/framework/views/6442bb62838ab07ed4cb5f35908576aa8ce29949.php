...
<?php $__env->startSection('title', 'FSTV | Operators list'); ?>
            ...
            <div class="panel panel-default card-view">
                <div class="panel-heading">
                    ...
                    <div class="pull-right">
                        <a href="<?php echo e(route('operator.create')); ?>" class="btn btn-default btn-rounded" style="border-bottom: 50%">
                                        ...
                                        <?php if($data): ?>
                                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                                                <tr>
                                                    ...
                                                    <td><ul>
                                                            <li><?php echo e(($row->operator_info['blog'] == 1) ? 'Blogs' : ''); ?></li>
                                                            <li><?php echo e(($row->operator_info['gallery'] == 1) ? 'Gallery' : ''); ?></li>
                                                            <li><?php echo e(($row->operator_info['adver'] == 1) ? 'Advertise' : ''); ?></li>
                                                        </ul>   
                                                    </td>
                                                    <td>
                                                        <ul class="nav nav-pills">
                                                            <li>
                                                                <a data-toggle="tooltip" data-placement="bottom" title="edit" href="<?php echo e(route('operator.edit', $row->id)); ?>">
                                                                    <i class="fa fa-edit fa-2x" style="color:#878787;"></i>
                                                                </a> 
                                                            </li>
                                                            <li>
                                                                <a data-toggle="tooltip" data-placement="bottom" title="delete" href="">
                                                                    <?php echo e(Form::open(['url'=>route('operator.destroy', $row->id), 'class'=>'form float-right', 'onsubmit'=>'return confirm("Are you sure to delete??")'])); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ausnepc/firescreen.ausnep.com/resources/views/admin/userlist/operator-list.blade.php ENDPATH**/ ?>