                                    ...
                                    <div class="post--item post--title-larger">
                                        <div class="row">
                                            <div class="col-md-4 col-sm-12 col-xs-4 col-xxs-12">
                                                <div class="post--img">
                                                    <a href="<?php echo e(asset('upload/post/'.$item->image)); ?>" class="thumb" style="height: 120px;"><img src="<?php echo e(asset('upload/post/'.$item->image)); ?>" alt=""></a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\fstv\resources\views/frontend/cat-post.blade.php ENDPATH**/ ?>