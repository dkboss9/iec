    ...
    <ul class="nav navbar-nav side-nav nicescroll-bar">
        ...
        <li>
            ...
            <ul id="post_dr" class="collapse collapse-level-1 two-col-list">
                <li>
                    <a href="<?php echo e(route('operator-publish-post')); ?>">Published News</a>
                </li>
                <li>
        ...
        <li>
            ...
            <ul id="video_dr" class="collapse collapse-level-1 two-col-list">
                <li>
                    <a href="<?php echo e(route('operator-publish-video')); ?>">Publish Videos</a>
                </li>
                <li>
        ...
        <li>
            ...
            <ul id="blog_dr" class="collapse collapse-level-1 two-col-list">
                <li>
                    <a href="<?php echo e(route('operator-publish-blog')); ?>">Publish Blogs</a>
                </li>
                <li>
        ...
        <li>
            ...
            <ul id="gallery_dr" class="collapse collapse-level-1 two-col-list">
                <li>
                    <a href="<?php echo e(route('operator-publish-gallery')); ?>">Publish Galleries</a>
                </li>
                <li>
        ...
        <li>
            ...
            <ul id="advertise_dr" class="collapse collapse-level-1 two-col-list">
                <li>
                    <a href="<?php echo e(route('operator-publish-advertise')); ?>">Publish Advertise</a>
                </li>
                <li>
                    <a href="<?php echo e(route('advertise.index')); ?>">Unpublish Advertise</a>
                </li>
            </ul>
        </li>
        <li><hr class="light-grey-hr mb-10"/></li>
...
</div><?php /**PATH /home/ausnepc/firescreen.ausnep.com/resources/views/operator/section/left-sidebar.blade.php ENDPATH**/ ?>