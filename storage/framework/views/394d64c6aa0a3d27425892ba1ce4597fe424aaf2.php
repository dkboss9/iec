    ...
    <div class="main--breadcrumb">
        <div class="container">
            <ul class="breadcrumb">
                ...
                <li class="active"><span><?php echo e(@$post[0]->cat_info['title']); ?></span></li>
            </ul>
        </div>
    </div>
    <!-- Main Breadcrumb End -->
                                    ...
                                    <div class="post--item post--title-larger">
                                        <div class="row">
                                            <div class="col-md-4 col-sm-12 col-xs-4 col-xxs-12">
                                                <div class="post--img">
                                                    <a href="<?php echo e(route('post-detail', $item->id)); ?>" class="thumb" style="height: 120px;"><img src="<?php echo e(asset('upload/post/Thumb-lg-'.$item->image)); ?>" alt=""></a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ausnepc/firescreen.ausnep.com/resources/views/frontend/cat-post.blade.php ENDPATH**/ ?>