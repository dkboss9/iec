    ...
    <div class="main--breadcrumb">
        <div class="container">
            <ul class="breadcrumb">
                ...
                <li class="active"><span><a href="<?php echo e(route('cat_video', @$childcat_video[0]->menu_info['id'])); ?>"></a><?php echo e(@$childcat_video[0]->menu_info['title']); ?></span></li>
                <li class="active"><span><a href="<?php echo e(route('subcat_video', @$childcat_video[0]->submenu_info['id'])); ?>"></a><?php echo e(@$childcat_video[0]->submenu_info['title']); ?></span></li>
                <li class="active"><span><?php echo e(@$childcat_video[0]->childmenu_info['title']); ?></span></li>
            </ul>
        </div>
    </div>
    <!-- Main Breadcrumb End -->
                ...
                <div class="main--content col-md-8 col-sm-7" data-sticky-content="true">
                    <div class="sticky-content-inner">
                        ...
                        <div class="post--items post--items-5 pd--30-0">
                            <ul class="nav">
                        <?php $count=1;?>
                        <?php $__currentLoopData = $childcat_video; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($count%3 == 1): ?>
                            <?php endif; ?>
                                <li>
                                    <!-- Post Item Start -->
                                    <div class="post--item post--title-larger">
                                        ...
                                        <span><a href="<?php echo e(route('childcat_video', $item->childmenu_info['id'])); ?>"><?php echo e($item->childmenu_info['title']); ?></a> </span>
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
                            ...
                            <div class="pagination--wrapper clearfix bdtop--1 bd--color-2 ptop--60 pbottom--30">
                               <?php echo e($childcat_video->render()); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ausnepc/firescreen.ausnep.com/resources/views/frontend/fstv/childcat-video.blade.php ENDPATH**/ ?>