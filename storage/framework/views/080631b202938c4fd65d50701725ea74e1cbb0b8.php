...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <?php echo e(Form::select('author_id',$author_info,@$media_detail->author_id, ['id'=>'author_id', 'require'=>false, 'class'=>'form-control form-control-sm','placeholder'=>'<--Select any one-->'])); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <?php echo e(Form::select('contributor_id',$contributor_info,@$media_detail->contributor_id, ['id'=>'contributor_id', 'require'=>false, 'class'=>'form-control form-control-sm','placeholder'=>'<--Select any one-->'])); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\fstv\resources\views/admin/media-form.blade.php ENDPATH**/ ?>