                                            ...
                                            <?php $i=0; ?>
                                                <?php $__currentLoopData = $blog_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo e(asset('upload/blog/'.$row->image)); ?>" target="_blank">
                                                               
                                                                <img src="<?php echo e(asset('upload/blog/'.$row->image)); ?>" style="max-width: 120px; max-height:90px;" alt="">
                                                            </a>
                                                        </td>
                                                        <td>
...
<?php echo $__env->make('layouts.operator', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ausnepc/firescreen.ausnep.com/resources/views/operator/blog.blade.php ENDPATH**/ ?>