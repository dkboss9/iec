        ...
        <div class="nav-header pull-left">
            <div class="logo-wrap">
                <a href="<?php echo e(route('home')); ?>">
                    <img class="brand-img" src="<?php echo e(asset('/upload/logos/'.auth()->user()->user_info['logo'])); ?>"width="30" height="35" alt=""/>
...
</nav><?php /**PATH C:\xampp\htdocs\fstv\resources\views/admin/section/top-navbar.blade.php ENDPATH**/ ?>