...
<div class="container-fluid pt-25">
    <div class="jq-toast-wrap top-right">
        <div class="jq-toast-single jq-has-icon jq-icon-success" style="text-align: left; display: relate;">
            ...
            <h2 class="jq-toast-heading">Welcome to Editor Dashboard</h2>
        </div>
    </div>
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                        <span class="txt-light block counter"><span class="counter-anim"><?php echo e($unpublish_epost->count()); ?></span></span>
                    ...
                    <div class="panel-body pa-0">
                        ...
                        <div class="sm-data-box bg-red">
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                        <span class="txt-light block counter"><span class="counter-anim"><?php echo e($unpublish_evideo->count()); ?></span></span>
...
<?php echo $__env->make('layouts.editor', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ausnepc/firescreen.ausnep.com/resources/views/editor/index.blade.php ENDPATH**/ ?>