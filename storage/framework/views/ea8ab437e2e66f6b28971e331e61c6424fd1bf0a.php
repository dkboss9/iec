...
<?php $__env->startSection('title','FSTV| Editors'); ?>
        ...
        <div class="col-sm-12">
            <div class="panel panel-default card-view col-md-8">
                <div class="panel-heading">
                    <div class="pull-left">
                        <h6 class="panel-title txt-dark">Editors <?php echo e(isset($user_detail)? 'Update' : 'Add'); ?> Form</h6>
                    </div>
                ...
                <div class="panel-wrapper collapse in">
                    ...
                    <?php if(isset($user_detail)): ?>
                        <?php echo e(Form::open(['url'=>route('editor.update', $user_detail->user_id), 'files'=>true, 'class'=> 'form'])); ?>

                        <?php echo method_field('put'); ?>
                    <?php else: ?>
                        <?php echo e(Form::open(['url'=>route('editor.store'), 'files'=>true, 'class'=> 'form'])); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ausnepc/firescreen.ausnep.com/resources/views/admin/userlist/editor-form.blade.php ENDPATH**/ ?>