                                            ...
                                            <?php $i=0; ?>
                                                <?php $__currentLoopData = $gallery_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo e(asset('upload/gallery/'.$row->image)); ?>">
                                                                <img src="<?php echo e(asset('upload/gallery/'.$row->image)); ?>" style="max-width: 120px; max-height:90px;" alt="">
                                                            </a>
                                                        </td>
                                                        <td><?php echo e(Timezone::convertToLocal($row->created_at)); ?></td>
                                                        <td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\fstv\resources\views/admin/gallery.blade.php ENDPATH**/ ?>