...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9" id="datetimepicker1">
                                    <?php echo e(Form::date('date', @$post_detail->date, ['id'=>'date','min'=> Carbon\Carbon::tomorrow(), 'require'=>false, 'class'=>'form-control form-control-sm'])); ?>                                
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ausnepc/firescreen.ausnep.com/resources/views/admin/post-form.blade.php ENDPATH**/ ?>