                                        ...
                                        <li class="col-md-12">
                                            ...
                                            <div class="post--item">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="post--img">
                                                            <a href="<?php echo e(route('post-detail', $item->id)); ?>" class="thumb" style="height: 250px;"><img src="<?php echo e(asset('upload/post/'.$item->image)); ?>" alt=""></a>
                                                            <a href="#" class="cat"><?php echo e($item->cat_info['title']); ?></a>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="post--content">
                                                            <p><?php echo Illuminate\Support\Str::limit(html_entity_decode($item->detail), 200); ?></p>
                                                        </div>
                                    ...
                                    <?php else: ?>
                                        <li class="col-md-6">
                                            ...
                                            <div class="post--item post--layout-4">
                                                <div class="post--img">
                                                    <a href="<?php echo e(route('post-detail', $item->id)); ?>" class="thumb" style="height:100px;"><img src="<?php echo e(asset('upload/post/'.$item->image)); ?>" alt=""></a>
                                                    <p class="utctime"><?php echo e(($item->created_at)); ?></p>
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ausnepc/firescreen.ausnep.com/resources/views/frontend/trending.blade.php ENDPATH**/ ?>