...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group row">
                                <?php echo e(Form::label('detail','Answer descriptions : ',['class'=>'col-sm-3'])); ?>

                                <div class="col-sm-9">
                                    <?php echo e(Form::textarea('detail', @$answer_detail->detail, ['class'=>'form-control form-control-sm', 'id'=>'q_detail', 'placeholder'=>'Enter question...', ''])); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\iec\resources\views/admin/quiz_questions/answer-form.blade.php ENDPATH**/ ?>