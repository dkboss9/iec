                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <ul class="nav nav-pills">
                                                            <li>
                                                                <a href="<?php echo e(route('post.edit', $row->id)); ?>">
                                                                    <i class="fa fa-edit fa-2x" style="color:#878787;"></i>
                                                                </a> 
                                                            </li>
                                                            <li>
                                                                <a href="javascript:void(0);" id="featured<?php echo e($row->id); ?>" class="<?php echo e(in_array($row->id, $featured_post_id)? 'unfeatured' : 'featured'); ?> " featured_id="<?php echo e($row->id); ?>">
                                                            ...
                                                            <li>
                                                                <a href="javascript:void(0);" id="popular<?php echo e($row->id); ?>" class="<?php echo e(in_array($row->id, $popular_post_id)? 'unpopular' : 'popular'); ?> " popular_id="<?php echo e($row->id); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\fstv\resources\views/admin/post.blade.php ENDPATH**/ ?>