    ...
    <div class="row">
        <div class="img-holder">
            ...
            <div class="info-holder">
                 <img class="logo-size" src="<?php echo e(asset('plugins/logo.png')); ?>" style="border-block-color: white; border:solid white 2mm " alt="logo">
            </div>
        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\iec\resources\views/auth/login.blade.php ENDPATH**/ ?>