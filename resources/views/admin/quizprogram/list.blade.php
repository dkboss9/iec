            ...
            <div class="panel panel-default card-view">
                <div class="panel-heading">
                    ...
                    <div class="pull-right">
                        <a href="{{ route('participant.create') }}" class="btn btn-default btn-rounded"
                    ...
                    <div class="pull-right">
                        <a href="{{ route('quizprogramcreate') }}" class="btn btn-default btn-rounded"
                            style="border-bottom: 50%">
                                ...
                                <table id="datable_1" class="table table-bordered table-hover display  pb-30">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $value->name }}</td>
                                            <td>{{$value->program_time}}</td>
                                            <td>{{$value->is_free}}</td>
                                            <td>
                                                <a href="{{ asset('upload/program/'.$value->image) }}">
                                                    {{-- {{$value->image}} --}}
                                                    <img src="{{ asset('upload/program/'.$value->image) }}"
                                            ...
                                            <td>
                                                <ul class="nav nav-pills">
                                                    <li>
                                                        <a href="{{ route('quizprogram/edit', $value->id) }}">
                                                            <i class="fa fa-edit fa-2x" style="color:#878787;"></i>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="">
                                                            {{ Form::open(['url'=>route('quizprogram/destroy', $value->id), 'class'=>'form float-right', 'onsubmit'=>'return confirm("Are you sure to delete??")']) }}
                                                            @method('delete')
