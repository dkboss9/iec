                                        ...
                                        @if($data)
                                            @foreach($data as $key => $value)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <ul>
                                                            @foreach ($value->participant_info as $item)
                                                                <li><a href="{{route('participant-detail',$item->id)}}">{{ucfirst($item->name)}}</a></li>
                                                            @endforeach                                                        
                                                        </ul>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <a href="{{ asset('upload/voting/'.$value->image) }}">
                                                            <img src="{{ asset('upload/voting/'.$value->image) }}" style="max-width: 150px; max-height:90px;" alt="">
                                                        </a>
                                                    </td>
                                                    <td>
