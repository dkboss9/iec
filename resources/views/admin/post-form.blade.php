                    ...
                    <div class="panel-body">
                        <div class="form-wrap">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    {{Form::select('status',['active'=>'Publish', 'inactive'=>'Unpublish'],@$post_detail->status, ['id'=>'status', 'require'=>true, 'class'=>'form-control form-control-sm']) }}
                                    @error('status')
                                    <span class="alert-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9" id="datetimepicker1">
                                    {{ Form::date('date', @$post_detail->date, ['id'=>'date','min'=> Carbon\Carbon::tomorrow(), 'require'=>false, 'class'=>'form-control form-control-sm']) }}                                
                                    @error('date')
                                    <span class="alert-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            {{-- <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    {{Form::select('author_id',$author_info,@$post_detail->author_id, ['id'=>'author_id', 'require'=>true, 'class'=>'form-control form-control-sm','placeholder'=>'<--Select any one-->']) }}
                                    @error('author_id')
                                    <span class="alert-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    {{Form::select('contributor_id',$contributor_info,@$post_detail->contributor_id, ['id'=>'contributor_id', 'require'=>true, 'class'=>'form-control form-control-sm','placeholder'=>'<--Select any one-->']) }}
                            ...
                            {{-- <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    {{Form::url('link',@$post_detail->link, ['class'=>'form-control form-control-sm', 'id'=>'link', 'placeholder'=>'Enter Video url...', 'require'=>false]) }}
                                    @error('link')
                                    <span class="alert-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    {{ Form::file('video', ['id'=>'video', 'required'=>false, 'accept'=>'video/mp4,video/x-m4v,video/*'])}} 
                                  @error('video')
                                    <span class="alert-danger">{{ $message }}upload video format</span>
                                    @enderror
                                </div>
                                <div class="col-sm-4">
                                    <div class="thumbnail {{(isset($post_detail)? '': 'hidden')}}" id="view" >
                                        <span class="close">&times;</span>
                                        @if (isset($post_detail->video))
                                        @if (file_exists(public_path().'/upload/post/video/'.$post_detail->video))
                                        <img id="old" src="{{ asset('/upload/post/video/'.$post_detail->video) }}">
                                        @endif
                                       @else
                                        @endif
                                        <img src="" id="preview">  
