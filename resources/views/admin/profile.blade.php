                        ...
                        <div class="panel-body  pa-0">
                            <div class="profile-box">
                                ...
                                <div class="profile-info text-center mt-30">
                                    ...
                                    <img src="{{ asset('/upload/users/'.auth()->user()->user_info['image']) }}" style="max-width: 200px; max-height:300px;" alt="">                                        
                                   
                                {{-- <img class="inline-block mb-10" src="{{ request()->user()->user_info['image']}}" alt="user"> --}}
                                ...
                                <div class="social-info">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                        <label><strong>Address:</strong> </label> {{auth()->user()->user_info['address']}}
                                        </div>                                        
                                        
                                        <div class="col-md-6">
                                        <label><strong>Phone:</strong> </label> {{auth()->user()->user_info['phone']}}
                                        </div>
                                    </div>                                   
                        
                                    <div class="row">
                                        <div class="col-md-6">
                                        <label><strong>Description:</strong> </label> {{auth()->user()->user_info['detail']}}
                                        </div>            
                                    </div>
