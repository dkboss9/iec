        ...
        <div class="col-sm-12">
            <div class="panel panel-default card-view col-md-8">
                <div class="panel-heading">
                    <div class="pull-left">
                        <h6 class="panel-title txt-dark">Editors {{ isset($user_detail)? 'Update' : 'Add' }} Form</h6>
                    </div>
                ...
                <div class="panel-wrapper collapse in">
                    ...
                    @if(isset($user_detail))
                        {{ Form::open(['url'=>route('editor.update', $user_detail->user_id), 'files'=>true, 'class'=> 'form']) }}
                        @method('put')
                    @else
                        {{ Form::open(['url'=>route('editor.store'), 'files'=>true, 'class'=> 'form']) }}
                    @endif
