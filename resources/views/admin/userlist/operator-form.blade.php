        ...
        <div class="col-sm-12">
            <div class="panel panel-default card-view col-md-8">
                <div class="panel-heading">
                    <div class="pull-left">
                        <h6 class="panel-title txt-dark">Operators {{ isset($user_detail)? 'Update' : 'Add' }} Form</h6>
                    </div>
                ...
                <div class="panel-wrapper collapse in">
                    ...
                    @if(isset($user_detail))
                        {{ Form::open(['url'=>route('operator.update', $user_detail->user_id), 'files'=>true, 'class'=> 'form']) }}
                        @method('put')
                    @else
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            {{Form::text('name', @$user_detail->info_user['name'], ['class'=>'form-control form-control-sm', 'id'=>'name', 'placeholder'=>'Enter Full name...', 'require'=>true]) }}
                            @error('name')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            {{Form::email('email', @$user_detail->info_user['email'], ['class'=>'form-control form-control-sm', 'id'=>'email', 'placeholder'=>'Enter User email...', 'require'=>(isset($user_detail) ? false : true )]) }}
                            @error('email')
                            <span class="alert-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            {{Form::text('citizenship', @$user_detail->citizenship, ['class'=>'form-control form-control-sm', 'id'=>'citizenship', 'placeholder'=>'Enter citizenship/passport number...', 'require'=>true]) }}
                            @error('citizenship')
                            <span class="alert-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            {{Form::text('other_id', @$user_detail->other_id, ['class'=>'form-control form-control-sm', 'id'=>'other_id', 'placeholder'=>'Enter User other_id...', 'require'=>false]) }}
                            @error('other_id')
                            <span class="alert-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            {{Form::checkbox('is_verified',1, @$user_detail->is_verified, ['id'=>'is_verified']) }}
                            Yes
                            @error('is_verified')
                            <span class="alert-danger">{{ $message }}</span>
                            @enderror
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            {{Form::select('status',['active'=>'Active', 'inactive'=>'Inactive'],@$user_detail->info_user['status'], ['id'=>'status', 'require'=>true, 'class'=>'form-control form-control-sm']) }}
                            @error('status')
                            <span class="alert-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            {{Form::checkbox('blog',1, @$user_detail->blog, ['id'=>'blog']) }}
                            Yes
                        </div>                        
                    </div> 
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            {{Form::checkbox('gallery',1, @$user_detail->gallery, ['id'=>'gallery']) }}
                            Yes
                        </div>
                    </div>
                    <div class="form-group row">
                        {{ Form::label('adver','Advertisement: ',['class'=>'col-sm-3']) }}
                        <div class="col-sm-9">
                            {{Form::checkbox('adver',1, @$user_detail->adver, ['id'=>'adver']) }}
                            Yes
                        </div>
                    </div>
                    <hr>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            {{Form::text('country', @$user_detail->country, ['class'=>'form-control form-control-sm', 'id'=>'country', 'placeholder'=>'Enter country...', 'require'=>true]) }}
                            @error('country')
                            <span class="alert-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            {{Form::text('city', @$user_detail->city, ['class'=>'form-control form-control-sm', 'id'=>'city', 'placeholder'=>'Enter city...', 'require'=>true]) }}
                            @error('city')
                            <span class="alert-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            {{Form::text('address', @$user_detail->address, ['class'=>'form-control form-control-sm', 'id'=>'address', 'placeholder'=>'Enter User address...', 'require'=>false]) }}
                            @error('address')
                            <span class="alert-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            {{Form::tel('phone', @$user_detail->phone, ['class'=>'form-control form-control-sm', 'id'=>'phone', 'placeholder'=>'Enter User phone...', 'require'=>false]) }}
                            @error('phone')
                            <span class="alert-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">   
                            {{Form::textarea('detail', @$user_detail->detail, ['class'=>'form-control form-control-sm', 'id'=>'detail', 'placeholder'=>'Enter Additional Information...', 'require'=>false,'rows'=>5,'style'=>'resize-none']) }}
                            @error('detail')
                            <span class="alert-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <div class="thumbnail {{(isset($user_detail)? '': 'hidden')}}" id="view" >
                                ...
                                @if (isset($user_detail))
                                @if (file_exists(public_path().'/upload/users/'.$user_detail->image))
                                <img id="old" src="{{ asset('/upload/users/'.$user_detail->image) }}">
                                @endif
                                @endif
                                <img src="" id="preview">  
                            </div>
