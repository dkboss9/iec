    ...
    <div class="main--breadcrumb">
        <div class="container">
            <ul class="breadcrumb">
                ...
                <li class="active"><span>{{@$post[0]->cat_info['title']}}</span></li>
            </ul>
        </div>
    </div>
    <!-- Main Breadcrumb End -->
                                    ...
                                    <div class="post--item post--title-larger">
                                        <div class="row">
                                            <div class="col-md-4 col-sm-12 col-xs-4 col-xxs-12">
                                                <div class="post--img">
                                                    <a href="{{asset('upload/post/'.$item->image)}}" class="thumb" style="height: 120px;"><img src="{{asset('upload/post/'.$item->image)}}" alt=""></a>
