                ...
                <div class="panel-wrapper collapse in">
                    <div class="panel-body">
                        <div class="form-wrap">
                            ...
                            <div class="form-group row">
                                {{ Form::label('link_type','Advertise Link Type* : ',['class'=>'col-sm-3']) }}
                                <div class="col-sm-9">
                                    {{Form::select('link_type',['internal'=>'Internal', 'external'=>'External'],@$advertise_detail->link_type, ['id'=>'link_type', 'placeholder'=>'Choose', 'require'=>true, 'class'=>'form-control form-control-sm']) }}
                                    @error('link_type')
                                    <span class="alert-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="url">
                                {{-- @if (@$advertise_detail)
                                    <div class="form-group row {{isset($advertise_detail->link)?'': 'hidden'}}">
                                        {{ Form::label('link','Link* : ',['class'=>'col-sm-3']) }}
                                        <div class="col-sm-9">
                                            {{Form::url('link',@$advertise_detail->link, ['class'=>'form-control form-control-sm', 'id'=>'link', 'placeholder'=>'Enter Advertise link...', 'require'=>false]) }}
                                        </div>
                                    </div>
                                    <div class="form-group row {{isset($advertise_detail->ilink)?'': 'hidden'}}">
                                        {{ Form::label('ilink','Link* : ',['class'=>'col-sm-3']) }}
                                        <div class="col-sm-9">
                                            {{Form::text('ilink',@$advertise_detail->ilink, ['class'=>'form-control form-control-sm', 'id'=>'ilink', 'placeholder'=>'Enter Advertise ilink...', 'require'=>false]) }}
                                        </div>
                                    </div>
                                @else --}}
                                    <div class="form-group row {{isset($advertise_detail->link)?'': 'hidden'}}" id="linkdiv">
                                        {{ Form::label('link','Link* : ',['class'=>'col-sm-3']) }}
                                        <div class="col-sm-9">
                                            {{Form::url('link',@$advertise_detail->link, ['class'=>'form-control form-control-sm', 'id'=>'link', 'placeholder'=>'Enter Advertise link...', 'require'=>false]) }}
                                        </div>
                                    </div>
                                    <div class="form-group row {{isset($advertise_detail->ilink)?'': 'hidden'}}" id="ilinkdiv">
                                        {{ Form::label('ilink','Link* : ',['class'=>'col-sm-3']) }}
                                        <div class="col-sm-9">
                                            {{Form::text('ilink',@$advertise_detail->ilink, ['class'=>'form-control form-control-sm', 'id'=>'ilink', 'placeholder'=>'Enter internal link...', 'require'=>false]) }}
                                        </div>
                                    </div>
                                {{-- @endif --}}
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    {{Form::select('status',['active'=>'Publish', 'inactive'=>'Unpublish'],@$advertise_detail->status, ['id'=>'status', 'require'=>true, 'class'=>'form-control form-control-sm']) }}
                                    @error('status')
                                    <span class="alert-danger">{{ $message }}</span>
                                    @enderror
                                </div>
