                ...
                <div class="panel panel-default card-view">
                    <div class="panel-heading">
                        ...
                        <div class="pull-right">
                            <a href="{{ route('childmenu.create') }}" class="btn btn-default btn-rounded" style="border-bottom: 50%">
                                            ...
                                            <?php $i=0; ?>
                                                @foreach ($data as $row) 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ $row->submenu_info->title}}</td>
                                                        <td>
                                                            <a href="{{ asset('upload/fstv/childmenu/'.$row->image) }}">
                                                                {{$row->image}}
                                                            </a> 
                                                        </td>
                                                        ...
                                                        <td>
                                                            <ul class="nav nav-pills">
                                                                <li>
                                                                    <a href="{{ route('childmenu.edit', $row->id) }}">
                                                                        <i class="fa fa-edit fa-2x" style="color:#878787;"></i>
                                                                    </a> 
                                                                </li>
                                                                <li>
                                                                    <a href="">
                                                                        {{ Form::open(['url'=>route('childmenu.destroy', $row->id), 'class'=>'form float-right', 'onsubmit'=>'return confirm("Are you sure to delete??")']) }}
                                                                        @method('delete')
