                                        ...
                                        <?php $i=0; ?>
                                            @foreach ($advertise as $row) 
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span><a href="{{asset('/upload/advertise/'.@$row->image)}}" target="_blank">{{ $row->type}}</a></span>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <ul class="nav nav-pills">
                                                            <li>
                                                                <a href="{{ route('advertise.edit', $row->id) }}">
                                                                    <i class="fa fa-edit fa-2x" style="color:#878787;"></i>
                                                                </a> 
                                                            </li>
                                                            <li>
                                                                <a href="">
                                                                    {{ Form::open(['url'=>route('advertise.destroy', $row->id), 'class'=>'form float-right', 'onsubmit'=>'return confirm("Are you sure to delete??")']) }}
                                                                    @method('delete')
