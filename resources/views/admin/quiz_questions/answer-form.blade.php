                ...
                <div class="panel-wrapper collapse in">
                    <div class="panel-body">
                        <div class="form-wrap">
                            ...
                            <div class="form-group row">
                                {{ Form::label('detail','Answer descriptions : ',['class'=>'col-sm-3']) }}
                                <div class="col-sm-9">
                                    {{Form::textarea('detail', @$answer_detail->detail, ['class'=>'form-control form-control-sm', 'id'=>'q_detail', 'placeholder'=>'Enter question...', '']) }}
                                    @error('detail')
                                    <span class="alert-danger">{{ $message }}</span>
                                    @enderror
                                </div>
