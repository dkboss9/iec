                    ...
                    <div class="panel-body">
                        <div class="form-wrap">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    {{Form::textarea('detail', html_entity_decode(@$blog_detail->detail), ['class'=>'form-control', 'id'=>'detail', 'placeholder'=>'Enter Category detail...', 'require'=>false, 'style'=>'resize: none;', 'rows' =>'5']) }}
                                  @error('detail')
                                    <span class="alert-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            {{-- <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    {{Form::select('author_id', $author_info,@$blog_detail->author_id, ['id'=>'author_id', 'require'=>true, 'class'=>'form-control form-control-sm','placeholder'=>'<--Select any one-->']) }}
                                    @error('author_id')
                                    <span class="alert-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    {{Form::select('contributor_id',$contributor_info,@$blog_detail->contributor_id, ['id'=>'contributor_id', 'require'=>true, 'class'=>'form-control form-control-sm','placeholder'=>'<--Select any one-->']) }}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    {{Form::select('status',['active'=>'Publish', 'inactive'=>'Unpublish'],@$blog_detail->status, ['id'=>'status', 'require'=>true, 'class'=>'form-control form-control-sm']) }}
                                    @error('status')
                                    <span class="alert-danger">{{ $message }}</span>
                                    @enderror
                                </div>
