                ...
                <div class="panel panel-default card-view">
                    <div class="panel-heading">
                        ...
                        {{-- <div class="pull-right">
                            <a href="{{ route('privacy.create') }}" class="btn btn-default btn-rounded" style="border-bottom: 50%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <ul class="nav nav-pills">
                                                                <li>
                                                                    <a href="{{ route('privacy.edit', $row->id) }}">
                                                                        <i class="fa fa-edit fa-2x" style="color:#878787;"></i>
                                                                    </a> 
                                                                </li>
                                                                {{-- <li>
                                                                    <a href="">
                                                                        {{ Form::open(['url'=>route('privacy.destroy', $row->id), 'class'=>'form float-right', 'onsubmit'=>'return confirm("Are you sure to delete??")']) }}
                                                                        @method('delete')
