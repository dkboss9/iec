                ...
                <div class="panel panel-default card-view">
                    <div class="panel-heading">
                        ...
                        <div class="pull-right">
                            <a href="{{ route('media.create') }}" class="btn btn-default btn-rounded" style="border-bottom: 50%">
                                            ...
                                            <?php $i=0; ?>
                                                @foreach ($media_data as $row) 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="utctime">{{ ($row->created_at) }}</td>
                                                        <td>
                                                            <ul class="nav nav-pills">
                                                                
                                                                <li>
                                                                    <a href="{{ route('media.edit', $row->id) }}">
                                                                        <i class="fa fa-edit fa-2x" style="color:#878787;"></i>
                                                                    </a> 
                                                                </li>
                                                                <li>
                                                                    <a href="">
                                                                        {{ Form::open(['url'=>route('media.destroy', $row->id), 'class'=>'form float-right', 'onsubmit'=>'return confirm("Are you sure to delete??")']) }}
                                                                        @method('delete')
