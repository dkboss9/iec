...
<div class="container-fluid">
    ...
    <div class="row heading-bg">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
          <h5 class="txt-dark">Editor Elements </h5>
        </div>
    </div>
    <!-- /Title -->
        ...
        <div class="col-sm-12">
            <div class="panel panel-default card-view col-md-8">
                <div class="panel-heading">
                    <div class="pull-left">
                        <h6 class="panel-title txt-dark">Editor {{ isset($user_detail)? 'Update' : 'Add' }} Form</h6>
                    </div>
                ...
                <div class="panel-wrapper collapse in">
                    ...
                    @if(isset($user_detail))
                        {{ Form::open(['url'=>route('editor.update', $user_detail->id), 'files'=>true, 'class'=> 'form']) }}
                        @method('put')
                    @else
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            {{Form::text('citizenship', @$user_detail->editor_info['citizenship'], ['class'=>'form-control form-control-sm', 'id'=>'citizenship', 'placeholder'=>'Enter citizenship/passport number...', 'require'=>true]) }}
                            @error('citizenship')
                            <span class="alert-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            {{Form::text('other_id', @$user_detail->editor_info['other_id'], ['class'=>'form-control form-control-sm', 'id'=>'other_id', 'placeholder'=>'Enter User other_id...', 'require'=>false]) }}
                            @error('other_id')
                            <span class="alert-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            {{Form::checkbox('is_verified',1, @$user_detail->editor_info['is_verified'], ['id'=>'is_verified']) }}
                            Yes
                            @error('is_verified')
                            <span class="alert-danger">{{ $message }}</span>
                            @enderror
                    ...
                    <div class="form-group row hidden">
                        ...
                        <div class="col-sm-9">
                            {{Form::checkbox('blog',1, @$user_detail->editor_info['blog'], ['id'=>'blog']) }}
                            Yes
                            @error('blog')
                            <span class="alert-danger">{{ $message }}</span>
                            @enderror
                    ...
                    <div class="form-group row hidden">
                        ...
                        <div class="col-sm-9">
                            {{Form::checkbox('gallery',1, @$user_detail->editor_info['gallery'], ['id'=>'gallery']) }}
                            Yes
                            @error('gallery')
                            <span class="alert-danger">{{ $message }}</span>
                            @enderror
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            {{Form::text('country', @$user_detail->editor_info['country'], ['class'=>'form-control form-control-sm', 'id'=>'country', 'placeholder'=>'Enter country...', 'require'=>true]) }}
                            @error('country')
                            <span class="alert-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            {{Form::text('city', @$user_detail->editor_info['city'], ['class'=>'form-control form-control-sm', 'id'=>'city', 'placeholder'=>'Enter city...', 'require'=>true]) }}
                            @error('city')
                            <span class="alert-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            {{Form::text('address', @$user_detail->editor_info['address'], ['class'=>'form-control form-control-sm', 'id'=>'address', 'placeholder'=>'Enter User address...', 'require'=>false]) }}
                            @error('address')
                            <span class="alert-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            {{Form::tel('phone', @$user_detail->editor_info['phone'], ['class'=>'form-control form-control-sm', 'id'=>'phone', 'placeholder'=>'Enter User phone...', 'require'=>false]) }}
                            @error('phone')
                            <span class="alert-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">   
                            {{Form::textarea('detail', @$user_detail->editor_info['detail'], ['class'=>'form-control form-control-sm', 'id'=>'detail', 'placeholder'=>'Enter Additional Information...', 'require'=>false,'rows'=>5,'style'=>'resize-none']) }}
                            @error('detail')
                            <span class="alert-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <div class="thumbnail {{(isset($user_detail)? '': 'hidden')}}" id="view" >
                                ...
                                @if (isset($user_detail))
                                @if (file_exists(public_path().'/upload/users/'.$user_detail->editor_info['image']))
                                <img id="old" src="{{ asset('/upload/users/'.$user_detail->editor_info['image']) }}">
                                @endif
                                @endif
                                <img src="" id="preview">  
                            </div>
