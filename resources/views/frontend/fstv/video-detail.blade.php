    ...
    <div class="main--breadcrumb">
        <div class="container">
            <ul class="breadcrumb">
                ...
                <li class=""><span><a href="{{route('cat_video', @$video->menu_info['id'])}}"></a>{{@$video->menu_info['title']}}</span></li>
                @if (@$video->submenu !== null)
                <li class=""><span><a href="{{route('subcat_video', @$video->submenu_info['id'])}}"></a>{{@$video->submenu_info['title']}}</span></li>
                @endif
                @if (@$video->childmenu != null)
                <li class=""><span><a href="{{route('childcat_video', @$video->childmenu_info['id'])}}"></a>{{@$video->childmenu_info['title']}}</span></li>
                @endif
                <li class="active"><span>{{$video->title}}</span></li>
            </ul>
        </div>
    </div>
    <!-- Main Breadcrumb End -->
                ...
                <div class="main--content col-md-8" data-sticky-content="true">
                    <div class="sticky-content-inner">
                        ...
                        <div class="post--item post--single post--title-largest pd--30-0">
                                ...
                                <div class="product" >
                                    <?php if($video->video != ''){ ?>
                                        <video style="display:block; margin: 0 auto;" height="400" 
                                            poster="{{asset('upload/fstv/video/'.$video->image)}}" 
                                            src="{{asset('upload/fstv/video/'.$video->video)}}" 
                                            playsinline controls>
                                        </video>
                                    <?php }else{ ?>
                                        {!! Embed::make($video->link)->parseUrl()->setAttribute([
                                        'width' => '100%',
                                        'height' => 420,
                                        'frameborder' => 0,
                            ...
                            <div class="post--info">
                                <p class="utctime">{{($video->created_at)}} </p>
                            ...
                            <div class="post--content">
                                <p>{!! html_entity_decode($video->detail) !!}</p>    
                            </div>
