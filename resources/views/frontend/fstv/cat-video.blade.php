    ...
    <div class="main--breadcrumb">
        <div class="container">
            <ul class="breadcrumb">
                ...
                <li class="active"><span>{{@$cat_video[0]->menu_info['title']}}</span></li>
            </ul>
        </div>
    </div>
    <!-- Main Breadcrumb End -->
                            ...
                            @endif
                                <li>
                                    ...
                                    <div class="post--item post--title-larger">
                                        ...
                                        <a href="{{route('subcat_video', $item->submenu_info['id'])}}">{{$item->submenu_info['title']}}</a>
