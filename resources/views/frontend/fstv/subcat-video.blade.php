    ...
    <div class="main--breadcrumb">
        <div class="container">
            <ul class="breadcrumb">
                ...
                <li class="active"><span>{{@$subcat_video[0]->menu_info['title']}}</span></li>
                <li class="active"><span>{{@$subcat_video[0]->submenu_info['title']}}</span></li>
            </ul>
        </div>
    </div>
    <!-- Main Breadcrumb End -->
                            ...
                            @endif
                                <li>
                                    ...
                                    <div class="post--item post--title-larger">
                                        ...
                                        <a href="">{{$item->submenu_info['title']}}</a>
                                        <span>@if(isset($item->childmenu_info)) >> <a href="{{route('childcat_video',$item->childmenu_info['id'])}}">{{$item->childmenu_info['title']}}</a> @endif</span>
                                    </div>
                                    <!-- Post Item End -->
                                </li> 
