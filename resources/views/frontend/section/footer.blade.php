<footer class="footer--section">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                <ul class="header--topbar-social nav">
                    <li>
                        <a class="" href="{{route('stripe')}}">
                            <i class="fa fa-credit-card"> </i> Stripe
                        </a>
                    </li>
                    <li>
                         <a class="" href="{{route('poli')}}">
            ...
            <div class="row AdjustRow">
                        ...
                        <div class="header--topbar-action float--left float--sm-none text-sm-center">
                            <h1 class="h1">
                                <a href="{{route('homepage')}}" class="btn-link">
                                    <img src="{{asset('plugins/logo1.png')}}" height="100" alt="FSTV LOGO"><span></span>
                ...
                <div class="col-md-2 col-xs-6 col-xxs-12 ptop--30 pbottom--30">
                    ...
                    <div class="widget">
                        ...
                        <div class="about--widget">
                            ...
                            <div class="action">
                                <a href="{{route('about-us')}}" class="btn-link">Read More<i class="fa flm fa-angle-double-right"></i></a>
                            </div>
                    ...
                    <div class="widget">
                        ...
                        <div class="links--widget">
                            ...
                            <ul class="nav">
                                ...
                                <li><a href="{{route('cat-post',$item->id)}}" class="fa-angle-right">{{$item->title}}</a></li>
                ...
                <div class="col-md-2 col-xs-6 col-xxs-12 ptop--30 pbottom--30">
                    ...
                    <div class="widget">
                        ...
                        <div class="links--widget">
                            <ul class="nav">
                                <li><a href="{{route('homepage')}}" class="fa-angle-right">Home</a></li>
                                <li><a href="{{route('contact-us')}}" class="fa-angle-right">Contact Us</a></li>
                                <li><a href="{{route('blog')}}" class="fa-angle-right">Blogs</a></li>
                                <li><a href="{{route('gallery')}}" class="fa-angle-right">Gallery</a></li>
                                <li><a href="{{route('popular')}}" class="fa-angle-right">Popular News</a></li>
                                <li><a href="" data-toggle="modal" data-target="#yourModal" class="fa-angle-right">Payments</a></li>
                                <li><a href="{{route('terms')}}" class="fa-angle-right">Terms of Use</a></li>
                                <li><a href="{{route('privacy')}}" class="fa-angle-right">Pivacy Policy</a></li>
                            </ul>
                        </div>
                        <!-- Links Widget End -->
                    </div>
                ...
                <div class="col-md-6 col-xs-6 col-xxs-12 ptop--30 pbottom--30">
                     <div class="row">
                         ...
                         <div class="col-md-6">
                             ...
                             <div class="widget">
                                 ...
                                 <div class="content">
                                     <p>For any enquiry, Please feel free to contact us</p><br>
                                 </div>
                                 ...
                                 <ul class="nav-links nav">
                                     ...
                                     <li>
                                         ...
                                         <span><a href="">{{$contact->phone}}</a></span>
                                     </li>
                                 </ul>
                                 <!-- Links Widget End -->
                             </div>
                             ...
                             <div class="widget">
                                 ...
                                 <div class="input-group-btn">
                                     ...
                                     {{-- <button type="" class="btn btn-lg btn-default active">SignUp now<i class="fa fa-paper-plane-o"></i></button> --}}
                                 </div>
                                 <!-- Links Widget End -->
                                 ...
                                 <div class="modal fade" id="signupModel" tabindex="-1" role="dialog" aria-labelledby="signupModelLabel">
                                     <div class="modal-dialog" role="document">
                                         <div class="modal-content">
                                             ...
                                             <div class="modal-body">
                                                 <form action="{{route('newssignup.store')}}" role="form" method="post" enctype="multipart/form-data">
                                                     @csrf
                  ...
                  <br><br>
                        ...
                        <div class="widget">
                            <div class="content">
                                <a href="https://apps.apple.com/us/app/firescreen-tv/id1559422281"><img src="{{asset('plugins/IOS.png')}}" style="height:60px; width:150px; margin-left: -8px;"></a>
                              <a href="https://play.google.com/store/apps/details?id=com.fstv"><img src="{{asset('plugins/Android.png')}}" style="height:60px; width:150px;"></a>                          
                          </div>
                        </div>
    ...
    <div class="footer--copyright bg--color-3">
        ...
        <div class="container">
            ...
            {{-- <ul class="nav links float--right" style="text-decoration-color: white">
