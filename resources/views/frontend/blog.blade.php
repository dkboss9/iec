                                    ...
                                    <div class="post--item post--title-larger">
                                        <div class="row">
                                            <div class="col-md-4 col-sm-12 col-xs-4 col-xxs-12">
                                                <div class="post--img">
                                                    <a href="{{route('blog-detail',$item->id)}}" class="thumb" style="height: 120px;"><img src="{{asset('upload/blog/'.$item->image)}}" alt=""></a>
                                            ...
                                            <div class="col-md-8 col-sm-12 col-xs-8 col-xxs-12">
                                                <div class="post--info">
                                                    ...
                                                    <div class="title">
                                                        <h3 class="h4"><a href="{{route('blog-detail', $item->id)}}" class="btn-link">{!! Illuminate\Support\Str::limit($item->title, 50) !!}</a></h3>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="post--action">
                                                    <a href="{{route('blog-detail', $item->id)}}">Continue Reading...</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="post--img">
                                                ...
                                                <div class="post--info">
                                                    {{-- <ul class="nav meta">
                                                        ...
                                                        <li><a class="time" href="#">{{Timezone::convertToLocal($item->created_at)}}</a></li>
                                                    </ul> --}}
                                    ...
                                    <li>
                                        ...
                                        <div class="post--item post--layout-3">
                                            <div class="post--img">
                                                ...
                                                <div class="post--info">
                                                    {{-- <ul class="nav meta">
                                                        <li><a href="#">{{$item->post_info['title']}}</a></li>
                                                        <li><a class="time" href="#">{{Timezone::convertToLocal($item->created_at)}}</a></li>
                                                    </ul> --}}
