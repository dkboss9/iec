    ...
    <div class="main--breadcrumb">
        <div class="container">
            <ul class="breadcrumb">
                ...
                <li><span>{{@$post[0]->cat_info['title']}}</span></li>
                <li class="active"><span>{{@$post[0]->sub_cat_info['title']}}</span></li>
            </ul>
        </div>
    </div>
    <!-- Main Breadcrumb End -->
                                    ...
                                    <div class="post--item post--title-larger">
                                        <div class="row">
                                            <div class="col-md-4 col-sm-12 col-xs-4 col-xxs-12">
                                                <div class="post--img">
                                                    <a href="{{route('post-detail', $item->id)}}" class="thumb"><img src="{{asset('upload/post/'.$item->image)}}" alt=""></a>
