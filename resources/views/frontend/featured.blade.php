    ...
    <div class="main--breadcrumb">
        <div class="container">
            <ul class="breadcrumb">
                ...
                <li><a class="btn-link active">Featured Posts</a></li>
            </ul>
        </div>
    </div>
    <!-- Main Breadcrumb End -->
                    ...
                    <div class="sticky-content-inner">
                        ...
                        <div class="col-md-12 ptop--30 pbottom--30">
                            <div class="post--items-title" data-ajax="tab">
                                <h2 class="h4">Top Featured News</h2>
                            </div>
                                            ...
                                            <li class="col-md-12">
                                                ...
                                                <div class="post--item">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="post--img">
                                                                <a href="{{route('post-detail', $item->post_id)}}" class="thumb" style="height: 250px;"><img src="{{asset('upload/post/'.$item->post_info['image'])}}" alt=""></a>
                                                                <a href="#" class="cat">{{$item->post_info->cat_info['title']}}</a>
                                                                {{-- <a href="{{route('featured')}}" class="icon"><i class="fa fa-star-o"></i></a> --}}
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="post--content">
                                                                <p>{!! Illuminate\Support\Str::limit(html_entity_decode($item->post_info['detail']), 200) !!}</p>
                                                            </div>
                            
                                                            <div class="post--action">
                                                                <a href="{{route('post-detail', $item->post_id)}}">Continue Reading...</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        @else
                                            <li class="col-md-6">
                                                ...
                                                <div class="post--item post--layout-4">
                                                    <div class="post--img">
                                                        <a href="{{route('post-detail', $item->post_id)}}" class="thumb" style="height:100px;"><img src="{{asset('upload/post/'.$item->post_info['image'])}}" alt=""></a>
                                                        ...
                                                        <div class="post--info">
                                                            ...
                                                            <div class="title">
                                                                <h3 class="h4"><a href="{{route('post-detail', $item->post_id)}}" class="btn-link">{!! Illuminate\Support\Str::limit($item->post_info['title'], 50) !!}</a></h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
